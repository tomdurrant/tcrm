...
class TrackMapFigure(MapFigure):
    ...
    def subplot(self, axes, subfigure):
        ...
        for track in tracks: # Hacked plotting of synthetic plots for now
...
def plotSyntheticTracks(configFile): # Hacked plotting of synthetic plots for now
...
if __name__ == "__main__":
    CONFIG = sys.argv[1]
    #main(CONFIG)
    plotSyntheticTracks(CONFIG) #Hacked plotting of synthetic plots for now
